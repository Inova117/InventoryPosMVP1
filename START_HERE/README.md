# 🚀 START HERE - MVP #1: Sistema de Inventario + POS
...
**User Story**: 
Como dueño, quiero agregar productos al inventario para gestionar mi catálogo...
...
Ver ENGINEERING.md → § 6.2 "Product Management Implementation"
```

### De ENGINEERING.md → PRODUCT.md

```typescript
## § 6.2 Product Management Implementation

**Satisfies**: PRODUCT.md → Feature #2

**Acceptance Criteria Reference**: 
- ✅ Add product form: `app/api/products/route.ts` POST endpoint
- ✅ SKU uniqueness validation: Database unique constraint + API check
- ✅ Price validation: Zod schema validates sell_price > buy_price (warning)
- ✅ Inventory list: `components/features/inventory/product-list.tsx`
